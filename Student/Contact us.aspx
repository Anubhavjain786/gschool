<%@ Page Language="C#" MasterPageFile="~/Student/StudentMaster.master" AutoEventWireup="true" CodeFile="Contact us.aspx.cs" Inherits="guest_Contact_us" Title="Untitled Page" %>
...
<p>
    ...
    <td>
        <asp:Button ID="Button2" runat="server" Text="Recruitment" Width="158px" 
            PostBackUrl="~/Student/feedback.aspx" />
    </td>
    </tr>
    </table>
       </p>
