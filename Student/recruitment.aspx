<%@ Page Language="C#" MasterPageFile="~/Student/StudentMaster.master" AutoEventWireup="true" CodeFile="recruitment.aspx.cs" Inherits="guest_recruitment" Title="Untitled Page" %>
...
<td width="100px">
    <asp:Button ID="Button2" runat="server" Text="Reset" 
        PostBackUrl="~/Student/recruitment.aspx" />
</td>
<td class="style6">
    <asp:Button ID="Button3" runat="server" Text="Cancel" 
        PostBackUrl="~/Student/Contact us.aspx" />
</td>
</tr>
</table>
</p>
