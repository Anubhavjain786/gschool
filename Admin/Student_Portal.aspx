<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Student_Portal.aspx.cs" Inherits="guest_Student_Portal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
    <ul style="width:100%">
         <li style="width:100%"><asp:button runat="server" text="Admission" style="width:80%" class="Student_portal" PostBackUrl="~/Admin/Addmision.aspx" /></li>
