<%@ Page Language="C#" MasterPageFile="~/User/UserMaster.master" AutoEventWireup="true" CodeFile="recruitment.aspx.cs" Inherits="guest_recruitment" Title="Untitled Page" %>
...
<td width="100px">
    <asp:Button ID="Button2" runat="server" Text="Reset" 
        PostBackUrl="~/User/recruitment.aspx" />
</td>
<td class="style6">
